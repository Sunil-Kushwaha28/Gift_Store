...
public class Payment1 extends AppCompatActivity implements View.OnClickListener {
    EditText txt_cno,txt_cvv,txt_name;
    TextView txt_amt;
    Spinner year,month;
    ArrayAdapter adapter1;
    ArrayAdapter adapter2;
    String t="",address,pno,price,name,amt,page;
    ProgressDialog pd;
                ...
                if (name.equals("") == false) {
                    if (expired == false) {
                        if (cvv.equals("") == false) {
                                ...
                                obj.execute();
                                pd = new ProgressDialog(Payment1.this);
                        ...
                        AlertDialog.Builder alert = new AlertDialog.Builder(Payment1.this);
    ...
    class DB_Conn extends AsyncTask<String,Void,String>
    {
        ...
        public String doInBackground(String...arg) //compulsory to implement
        {
            ...
            try {
                ...
                PreparedStatement pst1 = con.prepareStatement("select * from cart where userid=?");
                ...
                while (rs.next()) {
                    ...
                    PreparedStatement pst3 = con.prepareStatement("delete from cart where userid=?");
                    pst3.setString(1, userid);
                    pst3.executeUpdate();


                    t = t + "<tr><td>" + rs.getString("pro_name");
                    t = t + "<td>" + rs.getString("price");
                    t = t + "<td>" + rs.getString("qty");

                }
                    t = t + "</table>";
                    t = "Order no.: " + order_no + "<br/>" + t + "<br/>Grand Total: " + amt + "/-";
            ...
            if(result.equals("success"))
            {
                ...
                alert.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface obj, int x) {
                        ...
                        ed.clear();
                        ed.commit();
                        Intent i=new Intent(Payment1.this,Home.class);
                        startActivity(i);
