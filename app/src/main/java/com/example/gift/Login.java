...
public class Login extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn_login=(Button)findViewById(R.id.button_fp);
        btn_login.setOnClickListener(this);
        Button btn_signup=(Button)findViewById(R.id.button_login);
        btn_signup.setOnClickListener(this);
        Button btn_fp=(Button)findViewById(R.id.button_new);
    ...
    public void onClick(View v)
    {
        ...
        else if(v.getId()==R.id.button_fp) {
    ...
    class DB_Conn extends AsyncTask<String,Void,String>
    {
        ...
        public void onPostExecute(String result) //optional
        {
            ...
            if(result.equals("success"))
            {
                ...
                if (u.equalsIgnoreCase("admin@giftstore.com")) {
            ...
            else
            {
                ...
                alert.setMessage("Invalid UserId or Password");
